...
### Method: GET
>```
>https://qwasar-backend-my-api.onrender.com/users/4/edit
>```

⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃

## End-point: Editing user role
### Method: POST
>```
>https://qwasar-backend-my-api.onrender.com/users/4/edit
>```
...
## End-point: Home page (User)
### Method: GET
>```
>https://qwasar-backend-my-api.onrender.com/home/4
>```

⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃

## End-point: Get all users (Admin)
### Method: GET
>```
>https://qwasar-backend-my-api.onrender.com/admin
>```
...
### Method: GET
>```
>https://qwasar-backend-my-api.onrender.com/user/4/profile
>```
...
### Method: POST
>```
>https://qwasar-backend-my-api.onrender.com/signup
>```
### Body (**raw**)
...
### Method: POST
>```
>https://qwasar-backend-my-api.onrender.com/login
>```
### Body (**raw**)
...
### Method: DELETE
>```
>https://qwasar-backend-my-api.onrender.com/users/11/delete
>```

⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃

## End-point: Homepage (Earthquakes)
### Method: GET
>```
>https://qwasar-backend-my-api.onrender.com
>```

⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃

## End-point: Update Earthquake
### Method: PUT
>```
>https://qwasar-backend-my-api.onrender.com/update/4
>```
### Body (**raw**)
...
```json
{
    ...
    "magnitude": 3.1,
    "depth": 7,
    "date_time": "2024-05-21 18:00:00.0",
    "description": "Minor earthquake with minimal effects"
}
```
...
## End-point: Delete Earthquake
### Method: DELETE
>```
>https://qwasar-backend-my-api.onrender.com/delete/4
>```

⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃

## End-point: Insert Earthquake
### Method: POST
>```
>https://qwasar-backend-my-api.onrender.com/post
>```
### Body (**raw**)
...
```json
{
    ...
    "magnitude": 3.1,
    "depth": 7,
    "date_time": "2024-01-21 18:00:00.0",
    "description": "Minor earthquake with minimal effects"
}
```
